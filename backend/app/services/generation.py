...
INSTRUCTIONS:
1. Write a formal appeal letter addressed to the insurance company's appeals department.{address_instruction}
...
6. Do NOT include placeholder text like [MISSING], N/A, or None in the letter. If information is not available, simply omit it.
